...
<div class="container">
    <div class="text-center mb-50 wow fadeInUp">
        <h2 class="section-title text-center">Writer &amp; ESL Instructor<br />
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <ul class="nav nav-tabs nav-stacked flex-column">
                    <li class="active"><a href="#tab_a" class="waves-effect waves-light" role="tab"
                            data-toggle="pill">Fiction</a></li>
                    <li><a href="#tab_b" class="waves-effect waves-light" role="tab" data-toggle="pill">Non-Fiction</a>
                    </li>
                    <li><a href="#tab_c" class="waves-effect waves-light" role="tab" data-toggle="pill">Poetry</a></li>
                    <li><a href="#tab_d" class="waves-effect waves-light" role="tab" data-toggle="pill">TESL</a></li>
                </ul>
                <!-- <ul class="nav nav-tabs nav-stacked flex-column" role="tablist">
                    <li role="presentation" class="active"><a href="#tab-6" class="waves-effect waves-light" role="tab"
                    ...
                    <li role="presentation"><a href="#tab-5" class="waves-effect waves-light" role="tab"
                            data-toggle="tab">TESL</a></li>
                </ul> -->
            </div>
            <!-- /.col-md-3 -->
            <div class="col-sm-9">
                ...
                <div class="panel-body">
                    <div class="tab-content wow fadeInDown">
                        <div class="tab-pane active" id="tab_a">
                            <h2>Fiction</h2>
                            <img class="alignright" src="/dist/img/typewriter.jpg" alt="">
                            <div class="tab-container">
                                <h4>Excerpt from <em>"Walking Through Brambles: a narrative of
                                        circumspection"</em></h4>

                                <p>I stood on the balcony the following day and watched the winter birds
                                    ...
                                    brush resembling nests of crumpled wire.</p>

                                <p>The winter birds held the earth’s spirit. They lived and moved where
                                    ...
                                    declared its compassion, warmth, and color.</p>

                                <p>The birds flew off and gathered in the nearby meadow. When they were
                                ...
                                <p>I don’t remember dreaming. I only remember waking and feeling
                        ...
                        <div class="tab-pane" id="tab_b">
                            <h2>Non Fiction</h2>
                            <img class="alignright" src="/dist/img/laptop.jpg" alt="">
                            <div class="tab-container">
                                <h4>Identification and Storytelling:</h4>

                                <h5><em>The Appeal of Franklin Burroughs&rsquo; Narrative Essays</em></h5>

                                <p>In his collection of personal essays entitled, <em>Billy Watson&rsquo;s
                                        Croker Sack</em>, Franklin Burroughs utilizes the genre&rsquo;s
                                    most prevalent rhetorical strategy of identification through story
                                    telling. Unlike the formal essay that may appeal to an audience&rsquo;s
                                    specific interests and curiosities, Burroughs&rsquo; personal essays
                                    often appeal to a general audience&rsquo;s ambivalence between right
                                    ...
                                    intimate conversational rhetoric, he positions himself as the <em>everyman</em>.
                                    ...
                                    com&shy;mon to everyone. He attempts to communicate a reasoning that
                                    will casually blend the entire human race into one heterogenous
                                    family. Mainly through stories and anecdotes--the genre&rsquo;s
                                    primary rhetorical devise--Burroughs identifies with a general mass
                                    audience through a reverent conversation of life&rsquo;s minor
                                    generalities and a candid disclosure of his own failures and
                                    emotional fragility.</p>

                                <p>According to Holman and Harmon&rsquo;s <em>A Handbook to
                                        Literature</em>, the personal or informal essay is characterized
                                    by &ldquo;the personal element (self-revelation, individual tastes
                                    and experiences, confidential manner)...unconventionality or novelty
                                    of theme...and freedom from stiffness and affectation&rdquo; (Holman
                                    193). In his forward to <em>The Art of the Personal Essay</em>,
                                    Philip Lopate writes that &ldquo;the conversational dynamic--the
                                    desire for contact--is ingrained in the form, and serves to
                                    establish a quick emotional intimacy with the audience&rdquo;
                                    (Lopate 2). These observations are evidenced throughout Burroughs&rsquo;
                                    collection as he discusses life&rsquo;s personality from the
                                    perspective of the provincial New Englander. His collec&shy;tion
                                    consists of five essays all evaluating and reacting to the
                                    complexities of life and death in modern but rural America. He
                                    describes a local dimension of life that is free of the world&rsquo;s
                                    abrasive competitiveness, and he involves his readers in
                                    <em>his</em> world--a separate reality where he can confess his own
                                    fears and inadequacies.
                                </p>

                                <p>Recollections of boyhood and descriptions of the land&shy;scape are
                                    inherent in Burroughs&rsquo; essays. The innocence of childhood and
                                    nature &ldquo;undefiled&rdquo; is discussed in a homey,
                                    unpretentious rhetoric that appeals to the simple, unrefined,
                                    child-like qualities of his audience. He elaborates on the hillside&rsquo;s
                                    weeds and grasses and in a neighborly editorial on the weather, he
                                    discusses nature&rsquo;s routines and his own droll attitudes of
                                    home. &ldquo;Crackers limp as old lettuce,&rdquo; an expres&shy;sion
                                    bordering clich&eacute; is placidly expressed by a narrative voice
                                    which at times can be equally clich&eacute; or banal--simple,
                                    ...
                                    gazing at the valley before him as he describes &ldquo;our fields,&rdquo;
                                    in the following detail:</p>

                                <p style="padding-left: 60px;">The stitchwort, vetch, buttercup,
                                    ...
                                    more than aesthetic solace in them (Burroughs 9).</p>

                                <p>He further appeals to his and his audience&rsquo;s commonness in
                                    describing his &ldquo;Southern boyhood&rdquo; that was filled
                                    with &ldquo;that strange Wordsworthian hunger for landscape&rdquo;
                                    (Burroughs 10). Certainly by the end of the tenth page, readers can
                                    identify with Burroughs&rsquo; natural, uncomplicated
                                    self-portrait.</p>

                                <p>Throughout most of his book, Burroughs presents himself (as Edmund
                                    ...
                                    insights into everyday life. Lopate again in his forward to <em>The
                                        Art of the Personal Essay</em> informs us of the essayist as one
                                    who &ldquo;claims unique access to the small, humble things in life&rdquo;
                                    (Lopate 5). Bur&shy;roughs certainly attempts to portray this
                                    affection early in his collection and it is evidenced throughout the
                                    entire book. Lopate also notes that &ldquo;this taste for the
                                    miniature becomes a strong suit of the form: the ability to turn
                                    anything close at hand...into a grand meditation adventure&rdquo;
                                    (Lopate 9).</p>

                                <p>Burroughs is very much attuned to the quiet, ambient side of life,
                                    and although he doesn&rsquo;t embellish as much as other narrative
                                    writers may, he more closely scrutinizes the minia&shy;ture and
                                    discusses what most of us would consider unneces&shy;sary. This is
                                    particularly clear as he describes his activities on the opening day
                                    of duck hunting season.&nbsp;</p>

                                <p style="padding-left: 60px;">The day faded on into ordinariness; it
                                ...
                                <p>By omitting the subject of the final four phrases, Burroughs omits
                                    <em>himself</em> to suggest that even <strong><em>he</em></strong>
                                    is perhaps too obvious to mention and too ordinary to even care.
                                    This is a clear rhetori&shy;cal strategy that reiterates the event&rsquo;s
                                    ...
                                    and social obligations that most people will at some time encoun&shy;ter.
                                ...
                                <p>Burroughs is fascinated with milieu and the pace at which he moves
                                    ...
                                    collection relates significantly to this milieu and to the author&rsquo;s
                                    place within the natural world. This is particularly evident in the
                                    following passage from Burroughs&rsquo; third essay.</p>

                                <p style="padding-left: 60px;">It always seemed to be somewhere in the
                                ...
                                <p>Again, Burroughs&rsquo; story appeals to our sense of calm-ness--a
                                ...
                                <p style="padding-left: 60px;">So I would relapse into the Upper
                                    ...
                                    whetstone song, lapping and overlap&shy;ping itself in slow waves,
                                    until at last dusk fell, a faint coolness seeped out from the grass,
                                    and the toads and crickets took over (Burroughs 48).</p>

                                <p>Even if his reader never makes it to the mountains in Wyo&shy;ming or
                                    the backwoods of Kentucky, he has no trouble envisioning the comfort
                                    and peace of the places Burroughs describes.&nbsp;</p>

                                <p>Aside from these hum-drum normalities of life, Burroughs admits his
                                    ...
                                    He is bound to provincial exclu&shy;sion. His rhetoric is plaintive
                                ...
                                <p style="padding-left: 60px;">I was bookish and introverted as a boy,
                                    ...
                                    against my own standards, or against the modest and sensible expecta&shy;tions
                                    ...
                                    literature and without shape or certification (Burroughs 54-55).</p>

                                <p>While we are meant to understand Burroughs&rsquo; disillusion&shy;ment
                                    with life, we are also intended to relate to his queerish boyhood in
                                    order to find a perspective for <strong><em>our</em></strong>
                                    queerish natures. Lopate explains it this way. &ldquo;The trick is
                                    to realize that one is not important, except insofar as one&rsquo;s
                                    example can serve to elucidate a more widespread human trait and
                                    make readers feel a little less lonely and freakish&rdquo; (Lopate
                                    6).&nbsp;</p>

                                <p>Further insight into Burroughs&rsquo; audience can be seen in how the
                                    ...
                                    Burroughs confesses a fear in becom&shy;ing or remaining &ldquo;local,
                                    undistinguished and limited.&rdquo; But a more attentive reading
                                    ...
                                    that they too are &ldquo;local, undistinguished and limited.&rdquo;
                                    If we initially accept Burroughs&rsquo; appeal to an unsophisticated
                                    and general mass audience, we must also accept his reader&rsquo;s
                                    ...
                                    <em>local</em> minister, sales clerk or secretary may identify with
                                    Burroughs&rsquo; &ldquo;uncertified&rdquo; classification. Is it
                                ...
                                <p>Perhaps the most accurate analysis of Burroughs&rsquo; audience lies
                                    ...
                                    respect, it is reason&shy;able to believe that Burroughs is still
                                    ...
                                    reasonable to suspect that, <em>Billy Watson&rsquo;s Croker
                                        Sack</em> is a testament of the author&rsquo;s attempt to
                                    identify with <em>himself</em> and not solely with an
                                    unsophisticated, unassuming and undistinguished regional audience.
                                    Burroughs himself may indeed be the collection&rsquo;s primary
                                    audience.</p>

                                <p>Burroughs&rsquo; rhetoric is free of fancy terms, specialized jargon
                                    ...
                                    appeals to his audience&rsquo;s romantic moods and is able to use
                                    ...
                                    confessions with a measure of pity and responsibility for the author&rsquo;s
                                    ...
                                    literature. &ldquo;The true confessors have been aware that not only
                                    is life mostly failure, but that in one&rsquo;s failure or pettiness
                                    or wrongness exists the living drama of the self&rdquo; (Lopate
                                    9).</p>

                                <p>At times, Burroughs&rsquo; dependence upon his readers&rsquo;
                                    sympathy is excessive. After all, as Donald Harwood puts it, &ldquo;we
                                    all have our little sorrows&rdquo; and certainly Burroughs, like the
                                    rest of us, must deal with his personal traumas alone (Harwood 33).
                                    But as Lopate further explains, the personal essayist &ldquo;is not
                                    necessarily out to win the audience&rsquo;s unquali&shy;fied love
                                    but to present the complex portrait of a human being&rdquo; (Lopate
                                    8). And so Burroughs&rsquo; stories reflect the complexity of the
                                    <em>human</em> character, and the rhetorical treat&shy;ment he uses
                                    to identify with his audience, mainly gentle first-person story
                                    telling, reflects the complexities of the <em>poetical</em>
                                    character--something that even the most common among us hopes to
                                    possess.
                                </p>

                                <p>Burroughs&rsquo; text is rich with simple and plain observations made
                                    ...
                                    <em>Billy Watson&rsquo;s Croker Sack </em>doesn&rsquo;t necessarily
                                    escape in a rhetoric of elevated propor&shy;tions but is shown how
                                    his ordinariness is made grand in the perspective that Burroughs
                                    gives it. Irish essayist Hubert Butler explains it this way: &ldquo;I
                                    ...
                                    which I made myself&rdquo; (Lopate 10). Great or insignificant
                                    events in them&shy;selves cannot dictate the types of rhetorical
                                    ...
                                    rhetorical emphasis is placed on the writer&rsquo;s ability to
                                    identify with his audience. And according to Burroughs&rsquo; style
                        ...
                        <div class="tab-pane" id="tab_c">
                            <h2>Poetry</h2>
                            <img class="alignright" src="/dist/img/quill-and-ink.jpg" alt="">
                            <div class="tab-container">
                                <h4>A Meditation</h4>
                                ...
                                <p class="poetry">
                                    ...
                                    and just beyond the tide&rsquo;s reaching touch <br />
                                    ...
                                    and I succumb to her relentless serenity&mdash; <br />
                        ...
                        <div class="tab-pane" id="tab_d">
                            <h2>TESL</h2>
                            <img class="alignright" src="/dist/img/dada.jpg" alt="">
                            <div class="tab-container">
                                <p>Founded in 2013, DaDa is the leading online education platform based in China. Since
                                    its
                                    inception, DaDa&rsquo;s mission is to be the best online international school in
                                    China
                                    through one-on-one student-teacher pairing, world-class teaching content, and
                                    industry-leading two-way interactive learning platform.</p>

                                <p><strong>Mission:&nbsp;</strong>To ensure every child&rsquo;s happiness while
                                    learning<br />To provide a myriad of teaching materials that will inspire children
                                    to
                                    learn<br />To open their mind to our world<br />To provide the necessary tools that
                                    children will need in order to unlock their full potential in life.</p>
                            </div>
                        </div>
                        <!-- <div role="tabpanel" class="tab-pane write fade in active" id="tab-6">
                            <h2>Fiction</h2>
                            <img class="alignright" src="/dist/img/typewriter.jpg" alt="">
                            <div class="tab-container">
                                <h4>Excerpt from <em>"Walking Through Brambles: a narrative of
                        ...
                        <div role="tabpanel" class="tab-pane write fade in" id="tab-7">
                            <h2>Non Fiction</h2>
                            <img class="alignright" src="/dist/img/laptop.jpg" alt="">
                            <div class="tab-container">
                                <h4>Identification and Storytelling:</h4>
                        ...
                        <div role="tabpanel" class="tab-pane write fade" id="tab-8">
                            <h2>Poetry</h2>
                            <img class="alignright" src="/dist/img/quill-and-ink.jpg" alt="">
                            <div class="tab-container">
                                <h4>A Meditation</h4>
